...
from catalogue.db.utils import create_database, drop_database
from catalogue.services.kafka.dependencies import get_kafka_producer
from catalogue.services.kafka.lifetime import init_kafka, shutdown_kafka
from catalogue.services.redis.dependency import get_redis_pool
from catalogue.settings import settings
from catalogue.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    :yield: new engine.
    """
    from catalogue.db.meta import meta  # noqa: WPS433
    from catalogue.db.models import load_all_models  # noqa: WPS433
